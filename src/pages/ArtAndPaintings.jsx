...
export default function ArtAndPaintings() {
    ...
    const { data, isLoading, error } = useSWR("/products/search?category=Arts %26 Paintings", apiFetcher)
    ...
    return (
        <>
            ...
            {/* Hero Section */}
            <div className="bg-linear-65 from-amber-300 to-green-100 rounded-b-4xl max-w-screen-xl 
            ...
            <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-6 mt-10">
                ...
                <section className="lg:w-3/4 bg-white p-4 rounded-lg shadow-md">
                    <h4 className="text-xl font-medium text-gray-900 text-center mb-6">ART AND PAINTINGS</h4>
