            ...
            <section className="bg-[url(./assets/images/africanInspiredPatternSignupScreen.jpg)] rounded text-slate-800 flex items-center justify-center relative h-[100vh] bg-cover bg-center bg-no-repeat">
                ...
                <div className='relative z-10'>
                    <div className="md:flex items-center justify-center gap-8">
                        ...
                        <div className="mx-4 md:w-98 bg-white/80 backdrop-blur-md border border-white/90 rounded-xl shadow-lg p-8">
                            <h1></h1>
                            <form action="">
                                ...
                                <a href="" className="flex justify-center border-white/10 text-green-700 hover:text-[#29492f] font-semibold mt-2">Login</a>
                            </form>
                        </div>
                    </div>
                </div>
