                            ...
                            <form action={signUpVendor}>
                                ...
                                <div className='flex gap-4'>
                                    <div>
                                        ...
                                        <label htmlFor="" class="block font-medium">First Name</label>
                                        <input
                                            type="text"
                                            name="firstName"
                                            id=""
                                    ...
                                    <div>
                                        <label htmlFor="" class="block font-medium">Last Name</label>
                                        <input
                                            type="text"
                                            name="lastName"
                                            id=""
                                ...
                                <div className='flex gap-4'>
                                    ...
                                    <div>
                                        <label htmlFor="" class="block mt-1  font-medium">Email</label>
                                        <input
                                            type="email"
                                            name="email"
                                            id=""
                                    ...
                                    <div>
                                        <label htmlFor="" class="block font-medium">Telephone</label>
                                        <input
                                            type="tel"
                                            name="contact"
                                            id=""
                                ...
                                <div className='flex gap-4'>
                                    ...
                                    <div>
                                        <label htmlFor="" class="block mt-1  font-medium">Password</label>
                                        <input
                                            type="password"
                                            name="password"
                                            id=""
                                    ...
                                    <div>
                                        <label htmlFor="" class="block mt-1  font-medium">Confirm Password</label>
                                        <input
                                            type="password"
                                ...
                                <label htmlFor="" class="block mt-1  font-medium">Company Name</label>
                                <input
                                    type="text"
                                    name="shopName"
                                    id=""
                                    class="block w-full px-3 py-1.5 border border-gray-500 rounded-md shadow-sm focus:outline-none focus:ring-[#29492f] focus:border-green-700 sm:text-sm"
                                    placeholder="YAWKE ltd"
                                />

                                <label htmlFor="" class="block mt-1  font-medium">Company address</label>
                                <input
                                    type="text"
                                    name="shopAddress"
                                    id=""
