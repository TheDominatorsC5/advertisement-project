...
export default function HomeProductCards() {
    ...
    return (
        <div
            className="group relative max-w-sm rounded overflow-hidden shadow-lg bg-white hover:shadow-xl mt-10 w-full mx-auto">
            <img
            ...
            <div className="absolute inset-0 h-40 mt-56 bg-black bg-opacity-60 opacity-0 group-hover:opacity-80 transition-opacity duration-300 flex items-center justify-center">
                <div class="p-4">
